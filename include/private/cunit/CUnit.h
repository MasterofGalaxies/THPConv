...
#include <private/cunit/TestDB.h>   /* not needed here - included for user convenience */
...
#include <private/cunit/TestRun.h>  /* not needed here - include (after BOOL define) for user convenience */
