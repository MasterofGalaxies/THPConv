...
#define SAP_RESULT_CARD_POWERED_OFF     3   /* Error - card is powered off. */
#define SAP_RESULT_CARD_REMOVED         4   /* Error - card is not inserted. */
#define SAP_RESULT_CARD_ALREADY_ON      5   /* Error - card already turned on. */
...
**
*******************************************************************************/
BT_API extern void SAP_TransferApduReq(BT_HDR *p_reqbuf);
