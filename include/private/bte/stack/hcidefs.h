...
#define HCI_PROTO_VERSION     0x01      /* Version number for BT spec 1.1   */
#define HCI_PROTO_VERSION_1_2 0x02      /* Version number for BT spec 1.2   */
#define HCI_PROTO_VERSION_2_0 0x03      /* Version number for BT spec 2.0   */
#define HCI_PROTO_REVISION    0x000C    /* Current implementation version   */
/* 
**  Defenitions for HCI groups
*/
...
#define HCI_LINK_CTRL_CMDS_LAST         HCI_REJECT_ESCO_CONNECTION
...
#define HCI_CONT_BASEBAND_CMDS_LAST     HCI_WRITE_EXT_INQ_RESPONSE 
...
#define HCI_TESTING_CMDS_LAST           HCI_ENABLE_DEV_UNDER_TEST_MODE

#define HCI_VENDOR_CMDS_FIRST           0x0001
#define HCI_VENDOR_CMDS_LAST            0xFFFF

/* Commands of HCI_GRP_VENDOR_SPECIFIC group */
#ifdef _WIDCOMM
...
#define HCI_ADVANCED_PIN_CODE_REQUEST_EVT   0x30

#define HCI_EVENT_RSP_FIRST             HCI_INQUIRY_COMP_EVT 
#define HCI_EVENT_RSP_LAST              HCI_ADVANCED_PIN_CODE_REQUEST_EVT
...
#define HCI_DEFAULT_EVENT_MASK_1            0x00000000
...
#define HCI_SCAN_TYPE_INTERLACED        0x01       /* 1.2 devices only */
...
#define AFH_CHANNEL_MAP_LEN             10

/* Definitions for Extended Inquiry Response */
#define EXTENDED_INQ_RESPONSE_LEN       240
...
#define HCI_DEFAULT_INACT_TOUT          0x7D00
...
#define MAX_LMP_COMPID                  (LMP_COMPID_RESEARCH_IN_MOTION + 1)
