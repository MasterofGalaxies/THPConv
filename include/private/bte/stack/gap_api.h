...
#include <private/bte/stack/profiles_api.h>
...
/*******************************************************************************
**
** Function         GAP_SetDiscoveryParams
**
** Description      This function is called to set the BTM default discovery
**                  filters (UUID and attribute) for calls to BTM_StartDiscovery.
**
** Returns          void
**
*******************************************************************************/
GAP_API extern void GAP_SetDiscoveryParams (UINT16 num_uuid, tSDP_UUID *p_uuid_list,
                                            UINT16 num_attr, UINT16 *p_attr_list);

/*******************************************************************************
**
** Function         GAP_StartDiscovery
**
** Description      This function updates the local SDP database for the current
**                  remote devices' services.  The caller will usually call for an
**                  GAP_StartInquiry before calling this routine.
**
** Returns          GAP_CMD_INITIATED if successfully started
**                  GAP_ERR_BUSY if a discovery is already in progress
**                  GAP_NO_BDADDR_REC if there were no device addresses in the INQ database
**                  GAP_DEVICE_NOT_UP if the device has not been initialized yet
**                  GAP_ERR_PROCESSING if any other BTM error has been returned
**                  GAP_ERR_NO_CTRL_BLK if out of GAP resources
**
*******************************************************************************/
GAP_API extern UINT16 GAP_StartDiscovery (tGAP_CALLBACK *callback);
...
**
*******************************************************************************/
GAP_API extern UINT8 GAP_Bond (BD_ADDR bd_addr, UINT8 pin_len, UINT8 *p_pin,
                               UINT32 trusted_mask[]);
...
**
*******************************************************************************/
GAP_API extern UINT16 GAP_ConnOpen (char *p_serv_name, UINT8 service_id,
                                    BOOLEAN is_server, BD_ADDR p_rem_bda,
                                    UINT16 psm, tL2CAP_CFG_INFO *p_cfg, 
                                    UINT8 security, tGAP_CONN_CALLBACK *p_cb);
