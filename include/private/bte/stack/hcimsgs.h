...
#if BTM_PERIODIC_INQ_INCLUDED == TRUE
...
#else
#define btsnd_hcic_per_inq_mode(max_period, min_period, inq_lap, duration, response_cnt) FALSE
#define btsnd_hcic_exit_per_inq() FALSE
#endif  /* BTM_PERIODIC_INQ_INCLUDED */

#else
#define btsnd_hcic_inquiry(inq_lap, duration, response_cnt) FALSE
#define btsnd_hcic_inq_cancel() FALSE
#endif  /* BTM_INQUIRY_INCLUDED */
                                                                    /* Create Connection */
...
HCI_API extern void btsnd_hcic_accept_conn (void *buffer, BD_ADDR bd_addr, UINT8 role);
...
HCI_API extern void btsnd_hcic_reject_conn (void *buffer, BD_ADDR bd_addr, UINT8 reason);
...
HCI_API extern void btsnd_hcic_rmt_ext_features(void *buffer, UINT16 handle, UINT8 page_num);
...
HCI_API extern void btsnd_hcic_read_local_ext_features (void *buffer, UINT8 page_num);
...
HCI_API extern void btsnd_hcic_read_lmp_handle(void *buffer, UINT16 handle);       /* Remote LMP Handle */
...
HCI_API extern void btsnd_hcic_accept_esco_conn (void *buffer, BD_ADDR bd_addr,
                                                 UINT32 tx_bw, UINT32 rx_bw,
                                                 UINT16 max_latency,
                                                 UINT16 content_fmt,
                                                 UINT8 retrans_effort,
...
HCI_API extern void btsnd_hcic_reject_esco_conn (void *buffer, BD_ADDR bd_addr,
                                                 UINT8 reason);
...
/* Hold Mode */
HCI_API extern BOOLEAN btsnd_hcic_hold_mode(void *buffer, UINT16 handle, 
                                            UINT16 max_hold_period,
...
#define HCI_HOLD_MODE_MIN_PER_OFF       4
                                                                    ...
                                                                    /* Sniff Mode */
HCI_API extern BOOLEAN btsnd_hcic_sniff_mode(void *buffer, UINT16 handle,
...
HCI_API extern BOOLEAN btsnd_hcic_exit_sniff_mode(void *buffer, UINT16 handle);       /* Exit Sniff Mode */

                                                                    /* Park Mode */
HCI_API extern BOOLEAN btsnd_hcic_park_mode (void *buffer, UINT16 handle, UINT16 beacon_max_interval,
...
HCI_API extern BOOLEAN btsnd_hcic_exit_park_mode(void *buffer, UINT16 handle);  /* Exit Park Mode */
...
HCI_API extern void btsnd_hcic_role_discovery (void *buffer, UINT16 handle);       /* Role Discovery */
...
HCI_API extern void btsnd_hcic_read_def_policy_set(void *buffer); 

#define HCIC_PARAM_SIZE_READ_DEF_POLICY_SET           0
                                                                    /* Read Default Policy Settings */

                                                                    /* Write Default Policy Settings */
HCI_API extern void btsnd_hcic_write_def_policy_set(void *buffer, UINT16 settings);
...
#define HCI_WRITE_DEF_POLICY_SETTINGS_OFF        0
                                                                    ...
                                                                    /* Flow Specification */
HCI_API extern void btsnd_hcic_flow_specification(void *buffer, UINT16 handle, UINT8 flags, UINT8 flow_direct,
                           UINT8 service_type, UINT32 token_rate, UINT32 token_bucket_size, UINT32 peak, UINT32 latency);
...
#define HCI_FLOW_SPEC_LATENCY_OFF             17
                                                                    ...
                                                                    /* Sniff Subrating */
HCI_API extern void btsnd_hcic_sniff_sub_rate(void *buffer, UINT16 handle, UINT16 max_lat,
...
HCI_API extern void btsnd_hcic_write_ext_inquiry_response(void *buffer, UINT8 fec_req, UINT8 *p_data);  
...
#define HCIC_EXT_INQ_RESP_RESPONSE    1
                                                                    ...
                                                                    /* Set Event Mask */
HCI_API extern void btsnd_hcic_set_event_mask(void *buffer, EVENT_MASK evt_mask);
...
#define HCI_EVENT_MASK_MASK_OFF         0
                                                                    ...
                                                                    /* Reset */
HCI_API extern BOOLEAN btsnd_hcic_reset(void);
...
HCI_API extern void btsnd_hcic_set_event_filter(void *buffer, UINT8 filt_type, UINT8 filt_cond_type, UINT8 *filt_cond, UINT8 filt_cond_len);
...
HCI_API extern void btsnd_hcic_flush(void *buffer, UINT16 handle);                 /* Flush */

                                                                    /* Create New Unit Type */
HCI_API extern void btsnd_hcic_new_unit_key(void *buffer);

#define HCIC_PARAM_SIZE_NEW_UNIT_KEY     0
                                                                    /* Create New Unit Type */

                                                                /* Read Stored Key */
HCI_API extern void btsnd_hcic_read_stored_key (void *buffer, BD_ADDR bd_addr, BOOLEAN read_all_flag);
...
#define MAX_WRITE_KEYS 10
                                                                /* Write Stored Key */
HCI_API extern void btsnd_hcic_write_stored_key (void *buffer, UINT8 num_keys, BD_ADDR *bd_addr, LINK_KEY *link_key);
...
#define HCI_DELETE_KEY_ALL_FLAG_OFF     6
                                                                ...
                                                                /* Change Local Name */
HCI_API extern void btsnd_hcic_change_name(void *buffer, BD_NAME name);
...
HCI_API extern void btsnd_hcic_read_pin_type(void *buffer);                     /* Read PIN Type */
HCI_API extern BOOLEAN btsnd_hcic_write_pin_type(UINT8 type);                   /* Write PIN Type */
HCI_API extern void btsnd_hcic_read_auto_accept(void *buffer);                  /* Read Auto Accept */
HCI_API extern void btsnd_hcic_write_auto_accept(void *buffer, UINT8 flag);     /* Write Auto Accept */
HCI_API extern void btsnd_hcic_read_name (void *buffer);                        /* Read Local Name */
HCI_API extern void btsnd_hcic_read_conn_acc_tout(void *buffer);                /* Read Connection Accept Timout */
HCI_API extern void btsnd_hcic_write_conn_acc_tout(void *buffer, UINT16 tout);  /* Write Connection Accept Timout */
HCI_API extern void btsnd_hcic_read_page_tout(void *buffer);                    /* Read Page Timout */
HCI_API extern void btsnd_hcic_write_page_tout(void *buffer, UINT16 timeout);    /* Write Page Timout */
HCI_API extern void btsnd_hcic_read_scan_enable(void *buffer);                  /* Read Scan Enable */
HCI_API extern void btsnd_hcic_write_scan_enable(void *buffer, UINT8 flag);     /* Write Scan Enable */
HCI_API extern void btsnd_hcic_read_pagescan_cfg(void *buffer);                 /* Read Page Scan Activity */

                                                                /* Write Page Scan Activity */
HCI_API extern void btsnd_hcic_write_pagescan_cfg(void *buffer, UINT16 interval, UINT16 window); 
...
HCI_API extern void btsnd_hcic_read_inqscan_cfg(void *buffer);                  /* Read Inquiry Scan Activity */

                                                                /* Write Inquiry Scan Activity */
HCI_API extern void btsnd_hcic_write_inqscan_cfg(void *buffer, UINT16 interval, UINT16 window); 
...
HCI_API extern void btsnd_hcic_read_auth_enable(void *buffer);                   /* Read Authentication Enable */
HCI_API extern BOOLEAN btsnd_hcic_write_auth_enable(UINT8 flag);                 /* Write Authentication Enable */
HCI_API extern void btsnd_hcic_read_encr_mode (void *buffer);                    /* Read encryption mode */
HCI_API extern BOOLEAN btsnd_hcic_write_encr_mode (UINT8 mode);                  /* Write encryption mode */
HCI_API extern void btsnd_hcic_read_dev_class(void *buffer);                     /* Read Class of Device */
HCI_API extern void btsnd_hcic_write_dev_class(void *buffer, DEV_CLASS dev);     /* Write Class of Device */
HCI_API extern void btsnd_hcic_read_voice_settings(void *buffer);                /* Read Voice Settings */
HCI_API extern void btsnd_hcic_write_voice_settings(void *buffer, UINT16 flags); /* Write Voice Settings */
...
HCI_API extern void btsnd_hcic_read_auto_flush_tout(void *buffer, UINT16 handle);/* Read Retransmit Timout */

                                                                  /* Write Retransmit Timout */
HCI_API extern void btsnd_hcic_write_auto_flush_tout(void *buffer, UINT16 handle, UINT16 timeout);
...
HCI_API extern void btsnd_hcic_read_num_bcast_xmit(void *buffer);               /* Read Num Broadcast Retransmits */
HCI_API extern void btsnd_hcic_write_num_bcast_xmit(void *buffer, UINT8 num);   /* Write Num Broadcast Retransmits */
HCI_API extern void btsnd_hcic_read_hold_mode_act(void *buffer);                /* Read Hold Mode Activity */
HCI_API extern void btsnd_hcic_write_hold_mode_act(void *buffer, UINT8 flags);  /* Write Hold Mode Activity */

                                                                /* Read Tx Power */
HCI_API extern void btsnd_hcic_read_tx_power(void *buffer, UINT16 handle, UINT8 type);
...
HCI_API extern void btsnd_hcic_read_sco_flow_enable(void *buffer);                   /* Read Authentication Enable */
HCI_API extern void btsnd_hcic_write_sco_flow_enable(void *buffer, UINT8 flag);      /* Write Authentication Enable */
...
#define HCI_HOST_BUF_SIZE_SCO_NUM_OFF   5
                                                                ...
                                                                /* Set Host Buffer Size */
HCI_API extern void btsnd_hcic_host_num_xmitted_pkts (void *buffer, UINT8 num_handles, UINT16 *handle, 
                                       UINT16 *num_pkts); 
...
HCI_API extern void btsnd_hcic_read_link_super_tout(void *buffer, UINT16 handle);/* Read Link Supervision Timeout */

                                                                /* Write Link Supervision Timeout */
HCI_API extern BOOLEAN btsnd_hcic_write_link_super_tout(UINT16 handle, UINT16 timeout);
...
HCI_API extern void btsnd_hcic_read_max_iac (void *buffer);                    /* Read Num Supported IAC */
HCI_API extern void btsnd_hcic_read_cur_iac_lap (void *buffer);                /* Read Current IAC LAP */

                                                                /* Write Current IAC LAP */
HCI_API extern void btsnd_hcic_write_cur_iac_lap (void *buffer, UINT8 num_cur_iac, LAP * const iac_lap);
...
#define HCI_WRITE_IAC_LAP_LAP_OFF       1
                                                                ...
                                                                /* Read Clock */
HCI_API extern void btsnd_hcic_read_clock (void *buffer, UINT16 handle, UINT8 which_clock);
...
HCI_API extern void btsnd_hcic_read_page_scan_per (void *buffer);              /* Read Page Scan Period Mode */
HCI_API extern void btsnd_hcic_write_page_scan_per (void *buffer, UINT8 mode); /* Write Page Scan Period Mode */
HCI_API extern void btsnd_hcic_read_page_scan_mode (void *buffer);             /* Read Page Scan Mode */
HCI_API extern void btsnd_hcic_write_page_scan_mode (void *buffer, UINT8 mode);/* Write Page Scan Mode */
HCI_API extern BOOLEAN btsnd_hcic_read_local_ver (void);                       /* Read Local Version Info */
HCI_API extern void btsnd_hcic_read_local_supported_cmds (void *buffer);       /* Read Local Supported Commands */
HCI_API extern BOOLEAN btsnd_hcic_read_local_features (void);                  /* Read Local Supported Features */
HCI_API extern void btsnd_hcic_read_buffer_size (void *buffer);                /* Read Local buffer sizes */
HCI_API extern void btsnd_hcic_read_country_code (void *buffer);               /* Read Country Code */
HCI_API extern BOOLEAN btsnd_hcic_read_bd_addr (void);                         /* Read Local BD_ADDR */
HCI_API extern void btsnd_hcic_read_fail_conn_count (void *buffer, UINT16 handle);  /* Read Failed Contact Counter */
HCI_API extern void btsnd_hcic_reset_fail_conn_count (void *buffer, UINT16 handle); /* Reset Failed Contact Counter */
...
HCI_API extern void btsnd_hcic_read_loopback_mode (void *buffer);              /* Read Loopback Mode */
HCI_API extern void btsnd_hcic_write_loopback_mode (void *buffer, UINT8 mode); /* Write Loopback Mode */
HCI_API extern void btsnd_hcic_enable_test_mode (void *buffer);                /* Enable Device Under Test Mode */
HCI_API extern void btsnd_hcic_write_pagescan_type(void *buffer, UINT8 type);  /* Write Page Scan Type */
HCI_API extern void btsnd_hcic_read_pagescan_type(void *buffer);               /* Read Page Scan Type */
HCI_API extern void btsnd_hcic_write_inqscan_type(void *buffer, UINT8 type);   /* Write Inquiry Scan Type */
HCI_API extern void btsnd_hcic_read_inqscan_type(void *buffer);                /* Read Inquiry Scan Type */
HCI_API extern void btsnd_hcic_write_inquiry_mode(void *buffer, UINT8 type);   /* Write Inquiry Mode */
HCI_API extern void btsnd_hcic_read_inquiry_mode(void *buffer);                /* Read Inquiry Mode */
...
HCI_API extern void btsnd_hcic_set_afh_host_channel_class (void *buffer, UINT8 *p_afhchannelmap);
HCI_API extern void btsnd_hcic_read_afh_channel_assessment_mode(void *buffer);
HCI_API extern void btsnd_hcic_read_afh_channel_map (void *buffer, UINT16 handle);
HCI_API extern void btsnd_hcic_read_ext_inquiry_response(void *buffer);                   /* Read Extended Inquiry Response */
HCI_API extern void btsnd_hcic_nop(void *buffer);                               /* NOP */
...
HCI_API extern void btsnd_hcic_vendor_spec_cmd (void *buffer, UINT16 opcode, UINT8 len, UINT8 *p_data);
