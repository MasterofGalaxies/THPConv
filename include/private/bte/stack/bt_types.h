...
#define STREAM_TO_UINT16(u16, p) {u16 = (UINT16)(((UINT16)(*(p)) + (UINT16)(((UINT16)(*((p) + 1))) << 8))); (p) += 2;}
...
#define TRACE_TYPE_CMD_TX           0x00000009
#define TRACE_TYPE_EVT_TX           0x0000000a
#define TRACE_TYPE_ACL_TX           0x0000000b
#define TRACE_TYPE_CMD_RX           0x0000000c  
#define TRACE_TYPE_EVT_RX           0x0000000d
#define TRACE_TYPE_ACL_RX           0x0000000e
#define TRACE_TYPE_TARGET_TRACE     0x0000000f
#define TRACE_TYPE_MAX_NUM          16
