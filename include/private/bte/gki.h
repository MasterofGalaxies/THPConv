...
#define GKI_POOL_SIZE(pid)                                                  \
                                ((pid == GKI_POOL_ID_0)  ? GKI_BUF0_SIZE  : \
                                 (pid == GKI_POOL_ID_1)  ? GKI_BUF1_SIZE  : \
                                 (pid == GKI_POOL_ID_2)  ? GKI_BUF2_SIZE  : \
                                 (pid == GKI_POOL_ID_3)  ? GKI_BUF3_SIZE  : \
                                 (pid == GKI_POOL_ID_4)  ? GKI_BUF4_SIZE  : \
                                 (pid == GKI_POOL_ID_5)  ? GKI_BUF5_SIZE  : \
                                 (pid == GKI_POOL_ID_6)  ? GKI_BUF6_SIZE  : \
                                 (pid == GKI_POOL_ID_7)  ? GKI_BUF7_SIZE  : \
                                 (pid == GKI_POOL_ID_8)  ? GKI_BUF8_SIZE  : \
                                 (pid == GKI_POOL_ID_9)  ? GKI_BUF9_SIZE  : \
                                 (pid == GKI_POOL_ID_10) ? GKI_BUF10_SIZE : \
                                 (pid == GKI_POOL_ID_11) ? GKI_BUF11_SIZE : \
                                 (pid == GKI_POOL_ID_12) ? GKI_BUF12_SIZE : \
                                 (pid == GKI_POOL_ID_13) ? GKI_BUF13_SIZE : \
                                 (pid == GKI_POOL_ID_14) ? GKI_BUF14_SIZE : \
                                 (pid == GKI_POOL_ID_15) ? GKI_BUF15_SIZE : \
                                 0)
...
#if GKI_DEBUG == TRUE
GKI_API extern void    GKI_PrintBufferUsage(void);
