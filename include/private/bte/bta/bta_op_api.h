...
#define BTA_OP_VCARD_N              5       /* Name. */
#define BTA_OP_VCARD_ORG            6       /* Organization. */
#define BTA_OP_VCARD_TEL            7       /* Telephone number. */
#define BTA_OP_VCARD_TITLE          8       /* Title. */
#define BTA_OP_VCARD_URL            9       /* URL. */
#define BTA_OP_VCARD_LUID           10      /* Locally Unique Identifier. */
...
BTA_API extern void BTA_OpcEnable(tBTA_SEC sec_mask, tBTA_OPC_CBACK *p_cback,
                                  BOOLEAN single_op, UINT8 app_id);
