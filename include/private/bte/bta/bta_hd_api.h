...
**
** Description      Send a key press and key release report to the connected host              
**
** Returns          void
**
*******************************************************************************/
BTA_API void BTA_HdSendRegularKey (UINT8 modifier, UINT8 key_code);
...
**                  The report is sent as a keyboard report, key press report
**                  and key release report.
...
**
*******************************************************************************/
BTA_API void BTA_HdSendSpecialKey (UINT8 key_len, UINT8 * key_seq);
