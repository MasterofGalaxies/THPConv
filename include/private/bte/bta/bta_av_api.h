...
#define BTA_AV_FEAT_SUSPEND     0x0010  /* automatically sends SUSPEND when SNK sends START */
...
**                  with a BTA_AV_OPEN_EVT for each channel.
**
** Returns          void
**
*******************************************************************************/
BTA_API void BTA_AvOpen(BD_ADDR bd_addr, tBTA_AV_HNDL handle, tBTA_SEC sec_mask);
