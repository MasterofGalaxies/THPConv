...
#define BTA_AA_M12_HDR_SIZE         A2D_M12_MPL_HDR_LEN


/*******************************************************************************
**
** Function         bta_aa_m12_cfg_for_cap
**
...
**
*******************************************************************************/
extern UINT8 bta_aa_m12_cfg_for_cap(UINT8 *p_peer, tA2D_M12_CIE *p_cap, tA2D_M12_CIE *p_pref);

/*******************************************************************************
**
** Function         bta_aa_m12_cfg_in_cap
**
...
**
*******************************************************************************/
extern UINT8 bta_aa_m12_cfg_in_cap(UINT8 *p_cfg, tA2D_M12_CIE *p_cap);

/*******************************************************************************
**
** Function         bta_aa_m12_bld_hdr
**
...
**
*******************************************************************************/
extern void bta_aa_m12_bld_hdr(BT_HDR *p_buf, UINT16 frag_offset);
