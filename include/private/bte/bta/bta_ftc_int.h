...
#include <private/bte/bta/bta_ft_api.h>
#include <private/bte/bta/bta_fs_co.h>
#include <private/bte/bta/bta_fs_ci.h>
#include <private/bte/bta/bta_bi_api.h>
...
enum
{
    ...
    BTA_FTC_API_ABORT_EVT,          /* Response to an abort request */
    ...
    BTA_FTC_COMPRESS_SETUP_EVT,     /* Compress Setup Completion Event */
...
#define BTA_FTC_APH_PB_SIZE         0x08    /* PhoneBoonSize    2 byte      0x0000 to 0xFFFF */
...
/* data type for BTA_FTC_COMPRESS_SETUP_EVT */
typedef struct
{
    BT_HDR  hdr;
    UINT8   status;
} tBTA_FTC_COMPRESS_SETUP_EVT;
...
typedef union
{
    ...
    tBTA_FTC_COMPRESS_SETUP_EVT compress_setup_evt;
...
extern const tBTA_FTC_ACTION bat_ftc_bi_action[]; 
...
extern void bta_ftc_compress_setup(tBTA_FTC_CB *p_cb, tBTA_FTC_DATA *p_data);
...
extern BOOLEAN  bta_ftc_check_compress(tBTA_FTC_CB *p_cb);
