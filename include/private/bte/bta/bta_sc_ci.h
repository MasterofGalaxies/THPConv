...
#include <private/bte/bta/bta_sc_api.h>
...
**
*******************************************************************************/
BTA_API extern void bta_sc_ci_apdu(tBTA_SC_RESULT result, UINT8 *p_apdu, UINT16 apdulen);
...
**
*******************************************************************************/
BTA_API extern void bta_sc_ci_sim_reset(tBTA_SC_RESULT result);
