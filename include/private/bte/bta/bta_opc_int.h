...
#include <private/bte/bta/bta_op_api.h>
...
enum
{
    ...
    BTA_OPC_COMPRESS_SETUP_EVT,     /* Compress Setup Completion Event */
...
/* data type for BTA_OPC_COMPRESS_SETUP_EVT */
typedef struct
{
    BT_HDR  hdr;
    UINT8   status;
} tBTA_OPC_COMPRESS_SETUP_EVT;
...
typedef union
{
    ...
    tBTA_OPC_COMPRESS_SETUP_EVT compress_setup_evt;
...
extern void bta_opc_compress_setup(tBTA_OPC_CB *p_cb, tBTA_OPC_DATA *p_data);
...
extern BOOLEAN  bta_opc_check_compress(tBTA_OPC_CB *p_cb);
