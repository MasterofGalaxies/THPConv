...
/* AG feature masks */
#define BTA_AG_FEAT_3WAY    0x0001   /* Three-way calling */
#define BTA_AG_FEAT_ECNR    0x0002   /* Echo cancellation and/or noise reduction */
#define BTA_AG_FEAT_VREC    0x0004   /* Voice recognition */
#define BTA_AG_FEAT_INBAND  0x0008   /* In-band ring tone */
#define BTA_AG_FEAT_VTAG    0x0010   /* Attach a phone number to a voice tag */
#define BTA_AG_FEAT_REJECT  0x0020   /* Ability to reject incoming call */
#define BTA_AG_FEAT_ECS     0x0040   /* Enhanced Call Status */
#define BTA_AG_FEAT_ECC     0x0080   /* Enhanced Call Control */
#define BTA_AG_FEAT_EXTERR  0x0100   /* Extended error codes */
#define BTA_AG_FEAT_BTRH    0x0200   /* CCAP incoming call hold */
#define BTA_AG_FEAT_UNAT    0x0400   /* Pass unknown AT commands to application */
#define BTA_AG_FEAT_NOSCO   0x0800   /* No SCO control performed by BTA AG */
#define BTA_AG_FEAT_NO_ESCO 0x1000   /* Do not allow or use eSCO */

typedef UINT16 tBTA_AG_FEAT;
...
**
*******************************************************************************/
BTA_API void BTA_AgEnable(tBTA_AG_PARSE_MODE parse_mode, tBTA_AG_CBACK *p_cback);
