...
#include <private/bte/stack/bt_types.h>   /* This must be defined AFTER buildcfg.h */
#include <private/bte/stack/dyn_mem.h>    /* defines static and/or dynamic memory for components */
...
extern "C" {
#endif
extern void bte_hcisu_send (BT_HDR *p_msg, UINT16 event);
...
#define L2CAP_LINK_RECONNECT        FALSE
#endif
...
#define HID_DEV_SUBCLASS            MINOR_DEV_CLASS_PERIPHERAL_MOUSE
#endif
...
******************************************************************************/
#ifndef HCISU_EVT
#define HCISU_EVT                   EVENT_MASK(APPL_EVT_0)          /* Event mask reserved for handling HCIS events HCISU_TASK */
#endif
...
**
******************************************************************************/
#ifndef HCISU_H4_SLIP_INCLUDED
#define HCISU_H4_SLIP_INCLUDED          FALSE
#endif
...
#include <private/bte/common/bt_trace.h>
