/*---------------------------------------------------------------------------*
  ...
  Revision 1.4  2006/07/12 16:00:50  urata
  Clean up.

  Revision 1.3  2006/03/02 07:52:51  urata
  ...
  dolphinシースツリーから移植
    ...
    11    03/11/19 11:08 Hashida
    Added a comment.
    
    10    11/02/01 5:33p Hashida
    Renamed eu60 -> eurgb60
    
    9     11/01/01 3:37p Hashida
    Added EURGB60 mode support.
    
    8     10/18/01 12:06p Hashida
    No change.

    7     10/12/01 2:49a Hashida
    Added EU60 mode.
    
    6     9/19/01 12:26a Hashida
    Added DEBUG_PAL (NTSC 50Hz).
    
    5     8/11/00 6:26p Hashida
    Added 3D and progressive mode support
    
    4     5/15/00 1:52p Hashida
    Added definitions VI_MAX_WIDTH_NTSC, etc.
    
    3     2/25/00 11:29a Hashida
    Added VIRetraceCallback definition.
    
    2     1/26/00 6:32p Hashida
