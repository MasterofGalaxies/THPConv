/*---------------------------------------------------------------------------*
  ...
  dolphinシースツリーから移植
    ...
    4     4/21/99 4:12p Tianli01
    moved ICSync to OSIC.h

    3     4/12/99 7:45p Tianli01
    Added ICSync
