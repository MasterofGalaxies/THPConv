/*---------------------------------------------------------------------------*
  ...
  Imported from Dolphin tree.
    ...
    6     8/15/02 11:03a Billyjack
    added low pass filter articulator
    
    5     4/11/02 1:58p Billyjack
    - added IIR articulator, code commented out
    
    4     1/08/02 6:40p Billyjack
    - Added AXARTInitSound()
    
    3     9/26/01 3:44p Billyjack
    extern'd lfo samples for ANSI C compatibility
    
    2     8/20/01 6:15p Billyjack
    added comments
    
    1     8/15/01 1:11p Billyjack
    created
