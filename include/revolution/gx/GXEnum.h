/*---------------------------------------------------------------------------*
  ...
  dolphinシースツリーから移植
    ...
    7     2/04/00 5:09p Alligator
    added GX_TF_A8 type to textue formats.  For tex copy from alpha
    channel.
