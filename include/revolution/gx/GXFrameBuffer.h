/*---------------------------------------------------------------------------*
  ...
  Added the rendermode of proressive for PAL and MPAL.
  ...
  dolphinシースツリーから移植
    ...
    5     9/16/99 3:42p Alligator
    update render mode api

    4     9/09/99 3:04p Alligator
    move GXSetRenderMode to GX lib from emu

    3     9/02/99 3:18p Ryan
